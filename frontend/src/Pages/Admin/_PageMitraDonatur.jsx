...
export const MitraDonatur = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.get("sanctum/csrf-cookie").then(() => {
      axios
        .post("api/admin/mitra-donatur/store", data) // Make sure the endpoint is correct
        .then((res) => {
          setLoadSubmit(false);
  ...
  const handleDelete = (e) => {
    ...
    axios.get("sanctum/csrf-cookie").then(() => {
      axios
        .post("api/admin/mitra-donatur/delete/" + e.target.value)
        .then((res) => {
          ...
          <div className="md:flex md:columns-2 md:gap-10 -mt-96">
            ...
            <div className="bg-white md:rounded-xl rounded-sm shadow md:shadow-none w-full p-3 md:p-10 ">
              ...
              <div className="md:flex justify-center items-center gap-1">
                ...
                <div className="mt-2 md:w-1/3">
                  <label htmlFor="kegiatan" className="font-bold text-teal-600">
                    Kegiatan
                  </label>
                  <input
